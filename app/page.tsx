...
const translations = {
  en: {
    login: "Login",
    badge: "Gemini AI Assistant Powered",
    title_start: "The First",
    title_highlight: "AI-Powered",
    title_end: "WhatsApp Commerce",
    description: "Meet Gercep Assistant: Your 24/7 AI-powered shop manager. Search stores, browse menus, and place orders naturally via WhatsApp or Web Chat. Integrated with Google Gemini for the smartest retail experience.",
    ...
    new_order: "AI Order",
    whatsapp_features: "Your customers can search products and order just by chatting with our Gemini-powered AI Assistant.",
    ...
    flow_title_highlight: "Gemini AI Assistant.",
  ...
  id: {
    login: "Masuk",
    badge: "Didukung Gemini AI Assistant",
    title_start: "Platform",
    title_highlight: "Commerce AI",
    title_end: "Pertama di WhatsApp",
    description: "Kenalan dengan Gercep Assistant: Manajer toko bertenaga AI 24/7. Cari toko, lihat menu, dan pesan secara natural via WhatsApp atau Web Chat. Terintegrasi dengan Google Gemini.",
