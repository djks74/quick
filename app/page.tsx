...
const translations = {
  en: {
    ...
    new_order: "New Order",
    whatsapp_features: "Your customers can search products and order just by chatting with Gercep Assistant.",
    scan_demo: "Chat & Order via WhatsApp",
    contact_demo: "Chat for Demo",
    flow_subtitle: "How It Works",
    flow_title_start: "Smart shopping with",
    flow_title_highlight: "Gercep Assistant.",
    flow_description: "A complete flow where chat guides product discovery, checkout, payment, and shipping.",
    phase1_title: "Store Setup",
    phase1_subtitle: "Get your menu ready for chat-based ordering.",
    phase1_f1: "Automatic product indexing",
    phase1_f2: "Digital menu",
    phase1_f3: "Smart category organization",
    phase1_f4: "Merchant quick updates",
    ...
    phase2_f4: "24/7 assisted ordering",
    phase3_title: "Instant Checkout",
    ...
    phase4_subtitle: "Auto-calculated rates and delivery.",
    ...
    phase5_title: "Merchant Control",
    phase5_subtitle: "Manage your store via natural chat.",
    phase5_f1: "Update prices by chatting",
    phase5_f2: "Add products via WhatsApp",
    phase5_f3: "Real-time sales insights",
  ...
  id: {
    ...
    whatsapp_features: "Pelanggan Anda bisa mencari produk dan pesan hanya dengan chatting dengan Gercep Assistant.",
    scan_demo: "Chat & Pesan via WhatsApp",
    contact_demo: "Chat untuk Aktivasi Demo",
    flow_subtitle: "Cara Kerja",
    flow_title_start: "Belanja pintar dengan",
    flow_title_highlight: "Gercep Assistant.",
    flow_description: "Alur lengkap: cari produk, checkout, pembayaran, dan pengiriman lewat chat.",
    phase1_title: "Setup Toko",
    phase1_subtitle: "Siapkan menu untuk pemesanan via chat.",
    phase1_f1: "Indexing produk otomatis",
    phase1_f2: "Menu digital",
    phase1_f3: "Organisasi kategori pintar",
    phase1_f4: "Update cepat untuk merchant",
    ...
    phase2_f4: "Bantuan pemesanan 24/7",
    phase3_title: "Checkout Instan",
    ...
    phase4_subtitle: "Tarif dan pengiriman dihitung otomatis.",
    ...
    phase5_title: "Kendali Merchant",
    phase5_subtitle: "Kelola toko via chat natural.",
    phase5_f1: "Update harga via chat",
    phase5_f2: "Tambah produk via WhatsApp",
    phase5_f3: "Insight penjualan real-time",
