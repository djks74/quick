    ...
    <div className="space-y-4">
                  ...
                  <tr key={order.id} className="border-b border-[#f0f0f1] hover:bg-[#f6f7f7] transition-colors group">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-col">
                        <button onClick={() => handleViewOrder(order)} className="text-[#2271b1] font-bold hover:text-[#135e96] text-left">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
           <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in zoom-in duration-200">
              ...
              <div className="p-6 bg-gray-50 border-t flex gap-3">
                 <button onClick={() => { setSelectedOrder(null); setOrderDetails(null); }} className="flex-1 py-3 bg-white border border-gray-200 rounded-xl text-xs font-black uppercase tracking-widest text-gray-500 hover:bg-gray-100 transition-all">Close</button>
      ...
      <div className="flex items-center justify-between text-sm text-gray-600 py-2">
        ...
        <div className="flex items-center space-x-1">
          <button className="p-1 border border-[#ccd0d4] bg-white text-gray-400 cursor-not-allowed"><ChevronLeft className="w-4 h-4" /></button>
          <div className="px-3 py-1 border border-[#ccd0d4] bg-[#f0f0f1] font-medium">1</div>
          <button className="p-1 border border-[#ccd0d4] bg-white hover:bg-[#f6f7f7]"><ChevronRight className="w-4 h-4" /></button>
        </div>
      </div>
    </div>
  );
